                        ...
                        '<div class="modal-dialog">'+
                            '<div class="modal-content">'+
                                '<div class="modal-header">'+
                                    ...
                                    '<h4 class="modal-title" id="personLookupLabel">Person lookup for Orcid</h4>'+
                                    '<!-- DATASHARE - end -->'+
                                '</div>'+
                                    ...
                                    '<div title="Person Lookup">' +
                                        ...
                                        '<ul class="vcard list-unstyled" style="display: none;">' +
                                            ...
                                            '<li class="vcard-add">' +
                                                ...
                                                '<input class="ds-button-field btn btn-default" value="Add this Orcid for Person" type="button"/>' +
                                                '<!-- DATASHARE end -->'+
                                            '</li>' +
                                        '</ul>' +
                                    '</div>'+
